...
<header>
    ...
    <aside class="user-info">
        ${data.sessionData.login ? `<p>logged in as</p><p><a href="/login/profile"><b>${data.sessionData.login.username}</b></a></p>` : '<p>not logged in</p><p><a href="/profile/login">login</a></p>'}
    </aside>
</header>
`);
